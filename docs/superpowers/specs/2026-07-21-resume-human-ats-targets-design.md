...
The human target preserves the current visual hierarchy and four-card Impact grid. Its Skills section appears immediately after Impact and uses one full-width column. Each group is a compact row with a strong inline label followed by naturally wrapped, pill-shaped skill tags with a very light gray-lavender fill, subtle border, compact padding, and no icons or shadows.

Both targets render sections in the same canonical order: About, Impact, Skills, Work Experience, Education, Open Source, and Personal Projects.
...
- Both targets place Skills after Impact and before Work Experience.
