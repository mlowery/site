...
The human target preserves the current visual hierarchy and four-card Impact grid. Its Skills section presents the existing groups compactly, with each group labeled and its skills listed as text.
