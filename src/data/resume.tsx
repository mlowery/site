  ...
  projects: [
    {
      ...
      dates: "",
      active: true,
      description: "Go utility for scripting repeatable event routines and small command-line workflows.",
      technologies: ["Go"],
    ...
    },
    {
      ...
      dates: "",
      active: true,
      description: "Kubernetes workflow helper aimed at reducing context switching around kubeconfig usage.",
    ...
    },
    {
      ...
      dates: "",
      active: true,
      description: "Container tooling experiment for treating container images as executables.",
    ...
    },
    {
      ...
      dates: "",
      active: true,
      description: "kubectl watch automation helper for reacting to Kubernetes resource changes.",
